...
export const categories: Category[] = [
  // ───────────────────── STRUCTURAL ─────────────────────
  {
    ...
    subcategories: [
      {
        name: "Foundation",
        description: "The structural base that transfers building loads safely to the ground.",
        image: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?auto=format&fit=crop&w=600&q=80",
        whatIsIt: "Foundation is the lowest structural component of a building that directly interfaces with the earth. It distributes the entire weight of the structure across a sufficient area of soil to prevent settlement, tilting, or structural failure. Foundation types include isolated footings, combined footings, raft foundations, and pile foundations — each selected based on soil conditions and structural loads.",
        whyWeUseIt: [
          "Safely transfers building loads to the ground",
          "Prevents uneven settlement and structural tilting",
          "Provides stability against lateral forces and earthquakes",
          "Creates a moisture barrier between soil and structure",
          "Anchors the building firmly against wind uplift forces",
          "Enables multi-storey construction on diverse soil types"
        ],
        whereUsed: ["Foundation", "Basement", "Retaining Walls", "Underground Structures"],
        benefits: ["High Strength", "Settlement Prevention", "Earthquake Resistant", "Moisture Barrier", "Long Lasting"],
        qualityChecks: ["Soil Testing Report", "Design Load Verification", "Concrete Mix Design", "Rebar Placement Check", "Curing Period Compliance"],
        didYouKnow: "The depth of a foundation is determined by soil bearing capacity — poor soil may require pile foundations extending 15-30 meters deep.",
        constructionTip: "Always conduct a soil investigation test before designing the foundation. It determines the type and depth of foundation required.",
        qualityStandard: "All foundation work must comply with IS 1904 (Code of Practice for Design and Construction of Foundations).",
        brands: [
          {
            name: "UltraTech",
            description: "Premium foundation solutions using high-performance cement for maximum load-bearing capacity.",
            confirmed: true,
            country: "India",
            yearsInBusiness: 40,
            keyBenefits: ["High Strength", "Durability", "Sustainability"],
            whyWeChose: ["Consistent quality across batches", "Excellent compressive strength", "Nationwide availability", "Proven track record in premium projects"],
      ...
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1474631245212-32dc3c8310c6?auto=format&fit=crop&w=600&q=80",
      ...
      {
        name: "Concrete",
        description: "Ready-mix and site-mixed concrete for structural elements.",
        image: "https://images.unsplash.com/photo-1590069261209-f8e9b8642343?auto=format&fit=crop&w=600&q=80",
        whatIsIt: "Concrete is a composite material made of cement, water, aggregates (sand and gravel), and admixtures. It is the most widely used construction material in the world. Ready Mix Concrete (RMC) is manufactured in a factory or batching plant and delivered to the site in transit mixers, ensuring consistent quality and precise mix design.",
        whyWeUseIt: [
          "Provides the primary structural mass of buildings",
          "Excellent compressive strength for load bearing",
          "Can be molded into any shape before setting",
          "Fire resistant and durable",
          "Low maintenance over its service life",
          "Improved consistency with RMC"
        ],
        whereUsed: ["Foundation", "Columns", "Beams", "Slabs", "Walls", "Roof", "Staircase", "Swimming Pool"],
        benefits: ["High Strength", "Fire Resistant", "Low Maintenance", "Versatile", "Durable"],
        qualityChecks: ["Slump Test", "Cube Test (7 & 28 days)", "Mix Design Verification", "Water-Cement Ratio Check", "Admixture Dosage"],
        didYouKnow: "The compressive strength of concrete continues to increase even after 28 days — it can gain up to 99% of its ultimate strength by 1 year.",
        constructionTip: "Never add extra water to concrete at site. It reduces strength significantly. Use plasticizers for better workability instead.",
        brands: [
          {
            name: "UltraTech RMC",
            description: "India's largest ready-mix concrete provider with computerized batching plants ensuring precise mix design.",
            confirmed: true,
            country: "India",
            yearsInBusiness: 25,
            keyBenefits: ["Computerized Batching", "Consistent Quality", "Wide Grade Range"],
            whyWeChose: ["Precise mix design control", "On-time delivery", "Quality testing at plant", "Wide network of batching plants"],
          },
        ],
      },
      {
        name: "Masonry",
        description: "Blocks and bricks for wall construction and partitioning.",
        image: "https://images.unsplash.com/photo-1590069261209-f8e9b8642343?auto=format&fit=crop&w=600&q=80",
        whatIsIt: "Masonry involves construction with individual units such as bricks, blocks, and stones laid in mortar. Modern masonry uses AAC blocks, fly ash bricks, concrete blocks, and CLC blocks in addition to traditional red clay bricks. The choice of masonry unit affects thermal insulation, construction speed, and overall wall performance.",
        whyWeUseIt: [
          "Strong and durable wall construction",
          "Excellent thermal insulation properties",
          "Fire resistance for safety",
          "Sound insulation between rooms",
          "Cost effective for large wall areas",
          "Low maintenance over building lifetime"
        ],
        whereUsed: ["External Walls", "Internal Partitions", "Compound Walls", "Parapet Walls", "Garden Walls"],
        benefits: ["Fire Resistant", "Thermal Insulation", "Sound Insulation", "Durable", "Low Maintenance", "Eco Friendly"],
        qualityChecks: ["Compressive Strength Test", "Water Absorption Test", "Dimensional Accuracy", "Efflorescence Test", "Supplier Certification"],
        didYouKnow: "AAC blocks are 3-4 times lighter than traditional red bricks, reducing dead load on the structure by up to 30% and enabling faster construction.",
        constructionTip: "Pre-soak red bricks before use to prevent them from absorbing water from the mortar. AAC blocks should NOT be soaked — just lightly wetted.",
        brands: [
          {
            name: "AAC Blocks",
            image: "https://images.unsplash.com/photo-1590069261209-f8e9b8642343?auto=format&fit=crop&w=400&q=80",
            description: "Advanced lightweight cellular concrete blocks offering superior thermal insulation and faster construction speed.",
            confirmed: true,
            country: "India",
            keyBenefits: ["Thermal Insulation", "Lightweight", "Fire Resistant"],
            whyWeChose: ["3x lighter than red bricks", "Better thermal performance", "Faster construction", "Precise dimensions"],
          },
        ],
      },
      {
        name: "Aggregates",
        description: "Sand, gravel and crushed stone for concrete and construction.",
        image: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?auto=format&fit=crop&w=600&q=80",
        whatIsIt: "Aggregates are inert granular materials such as sand, gravel, and crushed stone used as filler in concrete and mortar. They constitute 60-80% of concrete volume and significantly influence its strength, workability, and durability. M Sand (manufactured sand) is increasingly preferred over river sand due to environmental regulations and consistent quality.",
        whyWeUseIt: [
          "Forms the bulk volume of concrete (60-80%)",
          "Provides dimensional stability to concrete",
          "Reduces overall concrete cost",
          "M Sand ensures consistent grading and quality",
          "Stone aggregates provide compressive strength",
          "Essential for proper concrete mix design"
        ],
        whereUsed: ["Concrete Mix", "Mortar", "Plastering", "Flooring", "Road Base", "Drainage"],
        benefits: ["Cost Effective", "Readily Available", "Consistent Quality", "Durable"],
        qualityChecks: ["Sieve Analysis", "Specific Gravity", "Water Absorption", "Silt Content", "Crushing Value Test"],
        didYouKnow: "M Sand (Manufactured Sand) has become the industry standard replacement for river sand, offering better quality control and environmental sustainability.",
        constructionTip: "Always test silt content in sand before use. Silt content above 8% can reduce concrete strength significantly.",
        brands: [
          {
            name: "Local Verified Suppliers",
            description: "Carefully selected and tested local aggregate suppliers meeting our strict quality parameters.",
            confirmed: true,
            keyBenefits: ["Tested Quality", "Consistent Supply", "Competitive Pricing"],
          },
        ],
      },
    ],
